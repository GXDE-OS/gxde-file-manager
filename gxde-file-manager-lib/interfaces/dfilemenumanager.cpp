...
#include "gxde-file-manager-plugins/plugininterfaces/menu/menuinterface.h"
...
void DFileMenuData::initData()
{
    ...
    actionKeys[MenuAction::RemoveFMBackground] = QObject::tr("Remove file manager background");
