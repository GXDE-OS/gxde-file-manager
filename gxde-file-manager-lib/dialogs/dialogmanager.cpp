...
void DialogManager::initTaskDialog()
{
    ...
    m_taskDialog->setWindowIcon(QIcon(":/images/images/gxde-file-manager.svg"));
...
void DialogManager::initCloseIndicatorDialog()
{
    ...
    m_closeIndicatorDialog->setWindowIcon(QIcon(":/images/images/gxde-file-manager.svg"));
...
void DialogManager::showAboutDialog(quint64 winId)
{
    ...
    QIcon productIcon;
    productIcon.addFile(":/images/images/gxde-file-manager_96.png", QSize(96, 96));
    productIcon.addFile(":/images/images/gxde-file-manager_96@2x.png", QSize(192, 192));
