...
private:
    ...
    BidirectionHash<QString, DFMApplication::GenericAttribute> keyToGA {
        ...
        {"advance.items_in_sidebar.videos", DFMApplication::GA_ShowVideosEntry},
        {"advance.items_in_sidebar.music", DFMApplication::GA_ShowMusicEntry},
        {"advance.items_in_sidebar.pictures", DFMApplication::GA_ShowPicturesEntry},
        {"advance.items_in_sidebar.documents", DFMApplication::GA_ShowDocumentsEntry},
        {"advance.items_in_sidebar.downloads", DFMApplication::GA_ShowDownloadsEntry},
        {"advance.items_in_sidebar.trash", DFMApplication::GA_ShowTrashEntry},
        {"advance.items_in_sidebar.computer", DFMApplication::GA_ShowComputerEntry},
        {"advance.items_in_sidebar.network", DFMApplication::GA_ShowNetworkEntry},
        {"advance.items_in_sidebar.tags", DFMApplication::GA_ShowTagEntry},
