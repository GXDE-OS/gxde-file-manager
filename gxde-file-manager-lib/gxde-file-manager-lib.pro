...
include(../gxde-file-manager-plugins/plugininterfaces/plugininterfaces.pri)
...
isEmpty(INCLUDE_INSTALL_DIR) {
    includes.path = $$PREFIX/include/gxde-file-manager
} else {
    includes.path = $$INCLUDE_INSTALL_DIR/gxde-file-manager
}
...
isEmpty(INCLUDE_INSTALL_DIR) {
    gvfs_includes.path = $$PREFIX/include/gxde-file-manager/gvfs
} else {
    gvfs_includes.path = $$INCLUDE_INSTALL_DIR/gxde-file-manager/gvfs
}

gvfs_includes.files += $$PWD/gvfs/*.h

isEmpty(INCLUDE_INSTALL_DIR) {
    plugin_includes.path = $$PREFIX/include/gxde-file-manager/gxde-file-manager-plugins
} else {
    plugin_includes.path = $$INCLUDE_INSTALL_DIR/gxde-file-manager/gxde-file-manager-plugins
}

plugin_includes.files += $$PWD/../gxde-file-manager-plugins/plugininterfaces/menu/*.h
plugin_includes.files += $$PWD/../gxde-file-manager-plugins/plugininterfaces/preview/*.h
plugin_includes.files += $$PWD/../gxde-file-manager-plugins/plugininterfaces/view/*.h

QMAKE_PKGCONFIG_LIBDIR = $$target.path
QMAKE_PKGCONFIG_VERSION = $$VERSION
QMAKE_PKGCONFIG_DESTDIR = pkgconfig
QMAKE_PKGCONFIG_NAME = gxde-file-manager
